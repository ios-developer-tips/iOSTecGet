...
//
//        [LSWBaseModel mj_objectArrayWithKeyValuesArray:<#(id)#>]
//        LSWBaseModel *model = [LSWBaseModel mj_objectWithKeyValues:obj];
//        [self setupChildVc:model.viewController title:model.titleName image:model.image selectedImage:model.selectedImage];
//    }];
