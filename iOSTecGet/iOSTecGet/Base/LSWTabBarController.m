...
- (void)viewDidLoad {
    ...
    [self setupChildVc:vc1 title:@"首页" image:@"home" selectedImage:@"home-selected"];
    [self setupChildVc:vc2 title:@"首页" image:@"home" selectedImage:@"home-selected"];
    [self setupChildVc:vc3 title:@"首页" image:@"home" selectedImage:@"home-selected"];
